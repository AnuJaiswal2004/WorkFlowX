    ...
    return (
        <div className="min-h-screen w-full bg-[#070b19] text-white p-6 md:p-10 relative overflow-hidden font-sans selection:bg-emerald-500/30 selection:text-emerald-400">
            ...
            <div className="relative z-10 max-w-7xl mx-auto space-y-8">
                ...
                <CreateTask onTaskCreated={fetchDashboardData} />
                {loading ? (
                    <div className="text-center py-10 text-gray-500">Loading team metrics...</div>
                ) : (
                    <AllTask employees={dashboardData?.employees || []} />
                )}
            </div>
        </div>
    );
